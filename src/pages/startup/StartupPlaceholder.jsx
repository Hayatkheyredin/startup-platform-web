/**
 * Placeholder for Startup dashboard. Shown when clicking "Startup" on landing until flow is built.
 */
import React from 'react'
import { Link } from 'react-router-dom'

function StartupPlaceholder() {
  return (
    <div className="min-h-screen flex flex-col bg-surface">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-text mb-2">Startup Dashboard</h1>
          <p className="text-text-muted mb-6">
            This section is coming soon. Founders will be able to sign up, submit their startup, and get validated.
          </p>
...
export default StartupPlaceholder
