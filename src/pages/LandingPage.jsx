 ...
 * Sections: Hero, About, Features, How It Works, Why Women Founders, Team, CTA, Footer.
 */
...
const TEAM = [
  { name: 'Meronn', role: 'Team', emoji: '👩‍💻' },
  { name: 'Hayat', role: 'Team', emoji: '🌟' },
  { name: 'Tsion', role: 'Team', emoji: '💼' },
  { name: 'Mekdelawit', role: 'Team', emoji: '✨' },
  { name: 'Tsion', role: 'Team', emoji: '🚀' },
]
    ...
    <div className="min-h-screen flex flex-col bg-surface antialiased">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-base md:text-lg shadow-lg">
                WSP
              </div>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute top-20 left-0 right-0 flex justify-center gap-4 md:gap-8 opacity-20 pointer-events-none text-4xl md:text-5xl">
            <span>🚀</span><span>💡</span><span>👩‍💼</span><span>💰</span><span>🌍</span>
          </div>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 relative">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-text mb-6 leading-tight">
                Empowering <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Women-Led</span> Startups
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  to="/investor"
                  className="px-6 py-3.5 rounded-xl font-semibold bg-gradient-to-r from-primary to-primary-hover text-white shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all"
                >
                  🚀 Explore Startups
                </Link>
                <Link
                  to="/investor"
                  className="px-6 py-3.5 rounded-xl font-semibold bg-white border-2 border-primary/30 text-primary hover:bg-primary/5 transition-colors"
                >
                  💼 Join as Investor
                </Link>
              </div>
        ...
        {/* ─── 3. Services / Features ─── */}
        <section id="services" className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-surface">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {[
                { Icon: IconDiscovery, emoji: '🔍', title: 'Startup Discovery', desc: 'Browse vetted women-led startups in one place. Filter by sector, stage, and impact.' },
                { Icon: IconInvestment, emoji: '💰', title: 'Smart Investment', desc: 'Track deals, manage portfolios, and follow startups from first pitch to scale.' },
                { Icon: IconValidation, emoji: '✅', title: 'Startup Validation', desc: 'Admin-verified startups so you invest in ideas that have passed our quality bar.' },
                { Icon: IconImpact, emoji: '🌍', title: 'Impact Investing', desc: 'Align capital with impact. Support founders who are building inclusive businesses.' },
              ].map(({ Icon, emoji, title, desc }) => (
                <div
                  key={title}
                  className="group p-6 md:p-8 rounded-2xl bg-white border border-slate-200/80 shadow-card hover:shadow-card-hover hover:border-primary/20 transition-all duration-300"
                >
                  <div className="flex items-center gap-3 mb-5">
                    <span className="text-3xl" aria-hidden>{emoji}</span>
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center text-primary group-hover:from-primary/20 group-hover:to-secondary/20 transition-colors">
                      <Icon />
                    </div>
                  </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              {[
                { step: '1', Icon: IconMobile, emoji: '📱', title: 'Startups submit ideas', desc: 'Founders submit their ventures through our mobile app. We collect pitch, traction, and team info.' },
                { step: '2', Icon: IconShield, emoji: '✅', title: 'Admin validates startups', desc: 'Our team reviews and validates each startup. Only verified companies appear for investors.' },
                { step: '3', Icon: IconRocket, emoji: '🚀', title: 'Investors discover & fund', desc: 'Investors browse validated startups, connect with founders, and fund the ones they believe in.' },
              ].map(({ step, Icon, emoji, title, desc }) => (
                <div key={step} className="relative text-center">
                  <div className="inline-flex w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-secondary text-white font-bold text-xl items-center justify-center mb-4 shadow-lg">
                    {step}
                  </div>
        ...
        <section id="team" className="py-16 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
              {TEAM.map((member, i) => (
                <div key={`${member.name}-${i}`} className="text-center p-6 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-primary/20 hover:shadow-card transition-all">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center mx-auto mb-4 text-3xl">
                    {member.emoji}
                  </div>
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-primary to-secondary">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/investor"
                className="px-6 py-3.5 rounded-xl font-semibold bg-white text-primary hover:bg-white/95 transition-colors"
              >
                🚀 Explore Startups
              </Link>
              <Link
      ...
      <footer className="bg-slate-900 text-slate-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              <Link to="/" className="inline-flex items-center gap-2 mb-4">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-sm">WSP</div>
                <span className="font-bold text-white">Women Startup Platform</span>
              </Link>
              <nav className="flex flex-wrap gap-6">
                ...
                <a href="#team" className="text-sm hover:text-white transition-colors">Team</a>
                <a href="#services" className="text-sm hover:text-white transition-colors">Services</a>
              </nav>
            </div>
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700/50 flex items-center justify-center hover:bg-primary/80 hover:text-white transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700/50 flex items-center justify-center hover:bg-primary/80 hover:text-white transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700/50 flex items-center justify-center hover:bg-primary/80 hover:text-white transition-colors" aria-label="GitHub">
          ...
          <div className="border-t border-slate-700/50 mt-10 pt-8 text-center md:text-left">
            <p className="text-sm text-slate-500">© {new Date().getFullYear()} Women Startup Platform. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
